...
int main(int argc, char **argv)
{
    ...
    google::InitGoogleLogging("map_pose"); // init google logging must be carried out after parse command line flags is carried out.
    ...
    map_pose::transaction_param_t trsct_prm;
    ...
    map_pose::Transaction transaction(trsct_prm);
